...
class Unit extends BaseController
{
	...
	public function json_unit(){
		...
		$sidx = $_POST['sidx']; // get index row - i.e. unit click to sort
		...
		foreach($get as $row){
			...
			$responce->rows[$i]['cell'] = array($row['id_unit'], $row['nama_unit']);
			$i++;
		}
